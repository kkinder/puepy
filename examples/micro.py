...
from puepy.core import t, Component

app = Application()
t.add_library(components)

app.base_title = "PuePy MicroPython"
...
class Card(Component):
    default_classes = ["card", "bg-base-100", "shadow-xl", "p-4"]

    def populate(self):
        with t.div(classes="card-body"):
            with t.h2(classes="card-title"):
                self.insert_slot("title")
            self.insert_slot()
